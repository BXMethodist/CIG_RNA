...
def get_real_table(target_cell_type, all_gene_GTF_path='/archive/tmhkxc48/ref_data/hg19/hg19.ucscgenes.knowngene.xls',
    ...
    # get feature parameter table
    best_feature_df = pd.read_csv(best_parameter_path)
    #best_feature_df = best_feature_df[best_feature_df['marker']!='H3K9me3']
...
if __name__ == '__main__':
    ...
    cell_types = os.listdir('/archive2/tmhbxx3/CancerLearn/data/normal/wigs_qn/peaks/')
    cell_type = cell_types[index]
    if cell_type != 'cardiac-muscle' or cell_type != 'neutrophil':
        get_real_table(cell_type, best_parameter_path='/archive2/tmhbxx3/CancerLearn/data/normal/wigs_qn/parameters_default.csv')
