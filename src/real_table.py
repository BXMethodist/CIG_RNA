...
def get_training_table(all_gene_GTF_path='../ref_data/mitranscriptome_lncRNA.gtf',
                       exclude_list_file='/home/tmhbxx3/scratch/CIG/test/related_genes/',
                       CIG_gene_df_path='CIG_strong_bo.csv',
                       best_parameter_path='../ref_data/parameters.csv', CIG_exclude_genes=None, candidates=None,
...
def get_real_table(target_cell_type, all_gene_GTF_path='../ref_data/mitranscriptome_lncRNA.gtf',
                       best_parameter_path='../ref_data/parameters.csv',
                       process=8,
                    out_name=None):
    ## get the CIG genesets and nonCIG genesets
    all_gene_GTF = pd.read_csv(all_gene_GTF_path, sep='\t', dtype={'hg19.kgXref.geneSymbol': str})
...
if __name__ == '__main__':
    # get_training_table(all_gene_GTF_path='/home/tmhbxx3/archive/ref_data/hg19/hg19.ucscgenes.knowngene_proteinOnly.xls',
    #                    best_parameter_path='best_parameters_CIG_v311.csv', CIG_gene_df_path='CIG_Bo_curated_311.xlsx',
    #                    process=8, size=1, exclude_list_file=None, random_seed=9000,
    #                    out_name='CIG_grid_training_v311_size1.csv')
    # get_training_table(all_gene_GTF_path='/home/tmhbxx3/archive/ref_data/hg19/hg19.ucscgenes.knowngene_proteinOnly.xls',
    #                    best_parameter_path='best_parameters_Great.csv', CIG_gene_df_path='CIG_Bo_curated_311.xlsx',
    #                    process=8, size=1, exclude_list_file=None, random_seed=9000,
    #                    out_name='CIG_Great_training_v311_size1.csv')
    # get_training_table(all_gene_GTF_path='/home/tmhbxx3/archive/ref_data/hg19/hg19.ucscgenes.knowngene_proteinOnly.xls',
    #                    best_parameter_path='best_parameters_CIG_v6.csv', CIG_gene_df_path='CIG_Bo_curated_311.xlsx',
    #                    process=8, size=1, random_seed=9000,
    #                    out_name='CIG_grid_training_v311_size1_related.csv')
    # get_training_table(all_gene_GTF_path='/home/tmhbxx3/archive/ref_data/hg19/hg19.ucscgenes.knowngene_proteinOnly.xls',
    #                    best_parameter_path='best_parameters_Great.csv', CIG_gene_df_path='CIG_Bo_curated_311.xlsx',
    #                    process=8, size=1, random_seed=9000,
    #                    out_name='CIG_Great_training_v311_size1_related.csv')

    #
    # get_training_table(all_gene_GTF_path='/home/tmhbxx3/archive/ref_data/hg19/hg19.ucscgenes.knowngene_proteinOnly.xls',
    #                    best_parameter_path='best_parameters_CIG_v6.csv', CIG_gene_df_path='CIG_Bo_curated_311.xlsx',
    #                    process=8, size=100, random_seed=9000,
    #                    out_name='CIG_grid_training_v311_size100_related.csv')
    # get_training_table(all_gene_GTF_path='/home/tmhbxx3/archive/ref_data/hg19/hg19.ucscgenes.knowngene_proteinOnly.xls',
    #                    best_parameter_path='best_parameters_Great.csv', CIG_gene_df_path='CIG_Bo_curated_311.xlsx',
    #                    process=8, size=100, random_seed=9000,
    #                    out_name='CIG_Great_training_v311_size100_related.csv')

    # get_training_table(all_gene_GTF_path='/home/tmhbxx3/archive/ref_data/hg19/hg19.ucscgenes.knowngene_proteinOnly.xls',
    #                    best_parameter_path='best_parameters_CIG_v311.csv', CIG_gene_df_path='CIG_Bo_curated_311.xlsx',
    #                    process=8, size=100, exclude_list_file=None, random_seed=9000,
    #                    out_name='CIG_grid_training_v311_size100.csv')
    # get_training_table(all_gene_GTF_path='/home/tmhbxx3/archive/ref_data/hg19/hg19.ucscgenes.knowngene_proteinOnly.xls',
    #                    best_parameter_path='best_parameters_Great.csv', CIG_gene_df_path='CIG_Bo_curated_311.xlsx',
    #                    process=8, size=100, exclude_list_file=None, random_seed=9000,
    #                    out_name='CIG_Great_training_v311_size100.csv')

    # get_training_table(best_parameter_path='best_parameters_CIG_v6.csv', CIG_gene_df_path='CIG_Bo_curated6.xlsx',
    #                    process=8, size=100, exclude_list_file=None,
    #                    out_name='CIG_grid_training_v6_size1_lg100.csv')
    # get_training_table(best_parameter_path='best_parameters_Great.csv', CIG_gene_df_path='CIG_Bo_curated6.xlsx',
    #                    process=8, size=100, exclude_list_file=None,
    #                    out_name='CIG_Great_training_v6_size1_lg100.csv')
    # get_training_table(best_parameter_path='best_parameters_CIG_v6.csv', CIG_gene_df_path='CIG_Bo_curated6.xlsx',
    #                    process=8, size=1.25, exclude_list_file=None, random_seed=9000,
    #                    out_name='CIG_grid_training_v6_size1_lg.csv')
    # get_training_table(best_parameter_path='best_parameters_Great.csv', CIG_gene_df_path='CIG_Bo_curated6.xlsx',
    #                    process=8, size=1.25, exclude_list_file=None, random_seed=9000,
    #                    out_name='CIG_Great_training_v6_size1_lg.csv')

    cell_types = ['CD34', 'GM12878', 'H1-hESC', 'HMEC', 'HSMM', 'MRG', 'MSC', 'neural', 'NHLF']
    cell_types = ['HUVEC']
    for cell_type in cell_types:
        # get_real_table('HUVEC', best_parameter_path='best_parameters_Great.csv',
        #                all_gene_GTF_path='/home/tmhbxx3/archive/ref_data/hg19/hg19.GREATgene2UCSCknownGenes.table.xls')
